...
$names = @('steam_api64.dll', 'steam_api64.pdb', 'Lua_LICENSE.txt',
    'Dawn/scripts/one_au.lua', 'Dawn/scripts/omega.lua', 'Dawn/scripts/deadly_trial.lua', 'Dawn/scripts/gateway.lua', 'Dawn/scripts/beyond_infinity.lua', 'Dawn/scripts/deep_storage.lua', 'Dawn/scripts/hijacked.lua', 'Dawn/scripts/strike_pact.lua', 'Dawn/scripts/strike_bond.lua', 'Dawn/scripts/mission_pact.lua', 'Dawn/scripts/mission_bond.lua', 'Dawn/scripts/eater_of_worlds.lua', 'Dawn/scripts/mercury_freeroam.json',
