...
ROOT = verify.ROOT
SCRIPTS = ('one_au.lua', 'homecoming.lua', 'adieu.lua', 'launchpad.lua', 'omega.lua', 'deadly_trial.lua', 'gateway.lua', 'beyond_infinity.lua', 'deep_storage.lua', 'hijacked.lua', 'strike_pact.lua', 'strike_bond.lua', 'mission_pact.lua', 'mission_bond.lua', 'eater_of_worlds.lua', 'mercury_freeroam.json',
